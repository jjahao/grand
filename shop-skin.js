  ...
  function buildPrettyList(liveCats) {
    ...
    if (!document.getElementById('gp-css')) {
      ...
      css.textContent = [
        ...
        '.gpd-content{display:grid;grid-template-columns:minmax(0,1.04fr) minmax(390px,.96fr)}.gpd-gallery{padding:28px;background:#FBF6EF;min-width:0}.gpd-stage{position:relative;display:grid;place-items:center;overflow:hidden;background:#fff;border-radius:17px;border:1px solid #EADFD3}.gpd-stage>img{display:block;width:100%;height:auto;max-height:72vh;object-fit:contain}',
